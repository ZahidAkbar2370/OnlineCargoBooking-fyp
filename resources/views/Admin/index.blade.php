    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ url('/admin') }}" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Online Cargo</span>
            </a>
        ...
        <div class="search-bar">
            {{-- <form class="search-form d-flex align-items-center" method="POST" action="#"> --}}
                ...
                <a  href="{{ url('/') }}"  type="button" title="Search" class="btn btn-success">Main Website</a>
            {{-- </form> --}}
        </div><!-- End Search Bar -->
...
{{-- 
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/admin/view-users') }}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/admin/cargo-history') }}">
                    <i class="bi bi-envelope"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/admin/request-cargo') }}">
                    <i class="bi bi-envelope"></i>
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ url('/data-insert') }}">
                            <i class="bi bi-circle"></i><span>Data Insert</span>
                        </a>
                    </li>
            ...
            {{-- <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/contact-us') }}">
                    <i class="bi bi-envelope"></i>
                    <span>Contact</span>
                </a>
